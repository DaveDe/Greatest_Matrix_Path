...
public class GreatestPath {
    ...
    public int findGreatestPath(Tile t){
        ...
        for(int i = 0; i < coordinates.size(); i++){
            coordinates.get(i).value = tiles5[coordinates.get(i).y][coordinates.get(i).x].c.value;
            coordinates.get(i).left = tiles5[coordinates.get(i).y][coordinates.get(i).x].c.left;
            coordinates.get(i).right = tiles5[coordinates.get(i).y][coordinates.get(i).x].c.right;
            coordinates.get(i).top = tiles5[coordinates.get(i).y][coordinates.get(i).x].c.top;
            coordinates.get(i).bottom = tiles5[coordinates.get(i).y][coordinates.get(i).x].c.bottom;
        }
    ...
    public void printTiles(){
        for(int i = 0; i < tiles5.length; i++){
            ...
            for(int j = 0; j < tiles5[i].length; j++){
                System.out.print(tiles5[i][j].c.value+" ");
            }
            System.out.println();
    ...
    public void setPointers(){
        ...
        //row 1
        tiles5[0][0].c.right = tiles5[0][1].c;
        tiles5[0][0].c.bottom = tiles5[1][0].c;

        tiles5[0][1].c.right = tiles5[0][2].c;
        tiles5[0][1].c.bottom = tiles5[1][1].c;
        tiles5[0][1].c.left = tiles5[0][0].c;

        tiles5[0][2].c.right = tiles5[0][3].c;
        tiles5[0][2].c.bottom = tiles5[1][2].c;
        tiles5[0][2].c.left = tiles5[0][1].c;

        tiles5[0][3].c.right = tiles5[0][4].c;
        tiles5[0][3].c.bottom = tiles5[1][3].c;
        tiles5[0][3].c.left = tiles5[0][2].c;

        tiles5[0][4].c.bottom = tiles5[1][4].c;
        tiles5[0][4].c.left = tiles5[0][3].c;

        //row 2
        tiles5[1][0].c.right = tiles5[1][1].c;
        tiles5[1][0].c.bottom = tiles5[2][0].c;
        tiles5[1][0].c.top = tiles5[0][0].c;

        tiles5[1][1].c.right = tiles5[1][2].c;
        tiles5[1][1].c.left = tiles5[1][0].c;
        tiles5[1][1].c.bottom = tiles5[2][1].c;
        tiles5[1][1].c.top = tiles5[0][1].c;

        tiles5[1][2].c.right = tiles5[1][3].c;
        tiles5[1][2].c.left = tiles5[1][1].c;
        tiles5[1][2].c.bottom = tiles5[2][2].c;
        tiles5[1][2].c.top = tiles5[0][2].c;

        tiles5[1][3].c.right = tiles5[1][4].c;
        tiles5[1][3].c.left = tiles5[1][2].c;
        tiles5[1][3].c.bottom = tiles5[2][3].c;
        tiles5[1][3].c.top = tiles5[0][3].c;

        tiles5[1][4].c.left = tiles5[1][3].c;
        tiles5[1][4].c.bottom = tiles5[2][4].c;
        tiles5[1][4].c.top = tiles5[0][4].c;

        //row 3
        tiles5[2][0].c.right = tiles5[2][1].c;
        tiles5[2][0].c.bottom = tiles5[3][0].c;
        tiles5[2][0].c.top = tiles5[1][0].c;

        tiles5[2][1].c.right = tiles5[2][2].c;
        tiles5[2][1].c.left = tiles5[2][0].c;
        tiles5[2][1].c.bottom = tiles5[3][1].c;
        tiles5[2][1].c.top = tiles5[1][1].c;

        tiles5[2][2].c.right = tiles5[2][3].c;
        tiles5[2][2].c.left = tiles5[2][1].c;
        tiles5[2][2].c.bottom = tiles5[3][2].c;
        tiles5[2][2].c.top = tiles5[1][2].c;

        tiles5[2][3].c.right = tiles5[2][4].c;
        tiles5[2][3].c.left = tiles5[2][2].c;
        tiles5[2][3].c.bottom = tiles5[3][3].c;
        tiles5[2][3].c.top = tiles5[1][3].c;

        tiles5[2][4].c.left = tiles5[2][3].c;
        tiles5[2][4].c.bottom = tiles5[3][4].c;
        tiles5[2][4].c.top = tiles5[1][4].c;

        //row 4
        tiles5[3][0].c.right = tiles5[3][1].c;
        tiles5[3][0].c.bottom = tiles5[4][0].c;
        tiles5[3][0].c.top = tiles5[2][0].c;

        tiles5[3][1].c.right = tiles5[3][2].c;
        tiles5[3][1].c.left = tiles5[3][0].c;
        tiles5[3][1].c.bottom = tiles5[4][1].c;
        tiles5[3][1].c.top = tiles5[2][1].c;

        tiles5[3][2].c.right = tiles5[3][3].c;
        tiles5[3][2].c.left = tiles5[3][1].c;
        tiles5[3][2].c.bottom = tiles5[4][2].c;
        tiles5[3][2].c.top = tiles5[2][2].c;

        tiles5[3][3].c.right = tiles5[3][4].c;
        tiles5[3][3].c.left = tiles5[3][2].c;
        tiles5[3][3].c.bottom = tiles5[4][3].c;
        tiles5[3][3].c.top = tiles5[2][3].c;

        tiles5[3][4].c.left = tiles5[3][3].c;
        tiles5[3][4].c.bottom = tiles5[4][4].c;
        tiles5[3][4].c.top = tiles5[2][4].c;

        //row 5
        tiles5[4][0].c.right = tiles5[4][1].c;
        tiles5[4][0].c.top = tiles5[3][0].c;

        tiles5[4][1].c.right = tiles5[4][2].c;
        tiles5[4][1].c.top = tiles5[3][1].c;
        tiles5[4][1].c.left = tiles5[4][0].c;

        tiles5[4][2].c.right = tiles5[4][3].c;
        tiles5[4][2].c.top = tiles5[3][2].c;
        tiles5[4][2].c.left = tiles5[4][1].c;

        tiles5[4][3].c.right = tiles5[4][4].c;
        tiles5[4][3].c.top = tiles5[3][3].c;
        tiles5[4][3].c.left = tiles5[4][2].c;

        tiles5[4][4].c.top = tiles5[3][4].c;
        tiles5[4][4].c.left = tiles5[4][3].c;
